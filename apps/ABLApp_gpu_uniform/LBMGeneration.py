...
with CodeGeneration() as ctx:
    ...
    lbm_config = LBMConfig(stencil=stencil, streaming_pattern=streaming_pattern,
                           ...
                           # following 2 lines are added to enable galilean correction for D3Q27 and disable it for D3Q19 (as it is not supported in cumulant method for D3Q19)
                           galilean_correction=use_galilean_correction,
                           fourth_order_correction=fourth_order_correction,
                           # above 2 lines are added to enable galilean correction for D3Q27 and disable it for D3Q19 (as it is not supported in cumulant method for D3Q19)
